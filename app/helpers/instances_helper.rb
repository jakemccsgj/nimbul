module InstancesHelper
    ...
    def stop_instance_image_submit(text, check_box_klass)
        empty_selection_msg = "Please select instances to stop."
        confirm_msg = 'The selected instance(s) will be stopped.\nAll data will be preserved.'
        html_options = {
            :name => 'stop',
            :alt => text,
            :class => 'control-icon',
            :title => "Stop selected instances",
            :onclick => "return confirm_multiple_action(this, '.instance_command', 'stop', '#{empty_selection_msg}', '#{confirm_msg}', '', '', '#{check_box_klass}');", 
        }
        image_submit_tag 'media-playback-pause.png', html_options
    end
    
    def start_instance_image_submit(text, check_box_klass)
        empty_selection_msg = "Please select instances to start."
        confirm_msg = 'The selected instance(s) will be started again if they are stopped.'
        html_options = {
            :name => 'start',
            :alt => text,
            :class => 'control-icon',
            :title => "Start selected instances",
            :onclick => "return confirm_multiple_action(this, '.instance_command', 'start', '#{empty_selection_msg}', '#{confirm_msg}', '', '', '#{check_box_klass}');", 
        }
        image_submit_tag 'media-playback-start.png', html_options
    end
