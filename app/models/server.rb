class Server < BaseModel
  ...
  has_many :instances, :dependent => :nullify, :include => [
  ...
  def self.options_for_find_by_provider_account(provider_account, options={})
  ...
  def self.find_all_by_provider_account(provider_account, options={})
    options = options_for_find_by_provider_account(provider_account, options)
    find(:all, options)
  end
