class CloudResource < BaseModel
    ...
    def destroy
        unless server_resources.empty?
            errors.add_to_base "used by some Server Resources."
            return false
        end
        unless instance_resources.empty?
            errors.add_to_base "used by some Instance Resources."
            return false
        end
        super
    end
