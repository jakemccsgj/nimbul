 ...
 * 
 * @param   str_pSwapId     String  The main id of the swap selection element
...
{
    // Set parent object if it was passed
    if (arguments[3]) {
        this.obj_parentNode = document.getElementById(arguments[3]);
    }
    // Set default values
    this.id = str_pSwapId;
...
function __swapSel_buildCode()
{
    ...
    for (i = 0; i < this.structure.length; i++)
    {
        ...
        obj_select.ondblclick = function(e) {
            swapSel_switchItems(obj_selfRef, true, false);
        }
		 
        obj_select.appendChild(obj_optionTag);
    }
  
    // Create 'swap_select_options' div and append it into main div
    ...
    obj_a.onclick = function(e) {
        swapSel_switchItems(obj_selfRef, true, true);
    }
    ...
    obj_a.onclick = function(e) {
        swapSel_switchItems(obj_selfRef, false, false);
    }
    obj_a.onkeydown = function(e) {
        if ((e.keyCode == 0) || (e.keyCode == 13)) swapSel_switchItems(obj_selfRef, true, false);
    }
    ...
    obj_a.onclick = function(e) {
        swapSel_switchItems(obj_selfRef, false, true);
    }
    obj_a.onkeydown = function(e) {
        if ((e.keyCode == 0) || (e.keyCode == 13)) swapSel_switchItems(obj_selfRef, true, false);
    }
    ...
    if (this.obj_parentNode) {
        obj_parentNode = this.obj_parentNode;
    } else {
